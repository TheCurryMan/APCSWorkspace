...
public class JUSafeTradeTest
{
    ...
    /**
     * TESTS THE TRADERWINDOW CLASS showMessage toString
     * 
     */
    @Test
...

    {
        ...
        try
        {
            boolean failtest = t.equals( object );
...

    {
        ...
        assertTrue( "<< Trader: getName should be " + name + " >>",
            trader.getName().equals( name ) );
...

    {
        ...
        assertTrue( "<< Trader: getPassword should be " + password + " >>",
            trader.getPassword().equals( password ) );
...

    {
        ...
        trader.openWindow();
        trader.getQuote( symbol );
        assertFalse( "<< Invalid Trader getQuote >>", trader.hasMessages() );
...

    {
        ...
        assertTrue( "<< Trader should have messages>>", trader.hasMessages() );
...

    {
        ...
        TradeOrder order = new TradeOrder( trader,
            ...
            10,
            10.0 );
        assertTrue( "<< Mailbox has messages >>", trader.mailbox().isEmpty() );
...

    {
        ...
        trader.quit();
        assertFalse( "<< Invalid message received >>",
...

    {
        ...
        trader.receiveMessage( "message" );
        assertFalse( "<< invalid receiveMessage >>", trader.mailbox().isEmpty() );
        trader.openWindow();
        trader.receiveMessage( "message" );
        assertTrue( "<< invalid receiveMessage >>", trader.mailbox().isEmpty() );
    ...
    public void stockConstructor()
    {
        ...
        assertTrue( "<< Invalid Stock Constructor >>",
            toStr.contains( "Stock[String stockSymbol:" + symbol )
                ...
                //&& toStr.contains( "PriorityQueue<TradeOrder> buyOrders:"
                //    + buyOrders )
                && toStr.contains( "PriorityQueue<TradeOrder> sellOrders:"
                    + sellOrders ) );
    }
